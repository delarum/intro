...
//make it an asynchronous code so that it does'nt throw that error
// 
...
// };
// fetch(apiUrl, {
//     method: "POST",//when you delete data you use delete, when you update data you use put, when you create data you use post
